...
public class SignInViewModelTests
{
    ...
    public SignInViewModelTests()
    {
        ...
        var resourceManager = A.Fake<ILocalizationResourceManager>();
        ...
        var options = new DbContextOptionsBuilder<DataContext>()
            .UseInMemoryDatabase("TestSignInDb")
            .Options;
    ...
    {
        public TestableSignInViewModel(FirebaseAuthClient authClient, IServiceProvider services,
            DataContext dataContext, SettingsViewModel settingsViewModel)
